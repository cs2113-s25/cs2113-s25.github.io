...
|     | <i>no lecture</i>   | Jan 22:  Lab 1: debugging with print statements exercise |   none |         
| 1    | Jan 27: [J0 Worksheet -- understanding unit tests](worksheet/j0) <br> [submitserver](https://submit.cs.seas.gwu.edu/courses) setup <br> review day 1 assesment <br> Internships, job searches, etc.| Jan 29: [lecture on markdown](https://docs.github.com/en/get-started/writing-on-github/getting-started-with-writing-and-formatting-on-github/basic-writing-and-formatting-syntax)<br> Lab 2: Debugging with unit tests | [J0 - Java, OOP, Encapsulation](j/0) |
